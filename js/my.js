...
jQuery(document).ready(function() {
        ...
        if (!e) {
            ...
            t.addClass("loading"), $.ajax({
                ...
                data: {
                    ...
                    postCount: $(".category-posts-wrap article").length,
    ...
    if(document.getElementsByClassName("sidebar_ad_placement").length > 0){
        ...
        function o(o) {
            ...
            s + 100 > t[o].offsetTop + t[o].offsetParent.offsetTop && s < n ? (e[o].style.position = "fixed", e[o].style.top = 10 + document.getElementById("masthead").offsetHeight + "px") : s > n ? (e[o].style.position = "absolute", e[o].style.top = "auto", e[o].style.bottom = "0") : (e[o].style.top = "0", e[o].style.position = "relative")
        }
