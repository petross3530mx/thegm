...
.single .entry-content p {clear: both; text-align: left; font-size: 18px;font-weight: 400;}
...
.footer-second-line .col-3 .textwidget img {margin-top: 7px;max-width:90px !important;}
.textwidget small {color: white;}
.footer-second-line .widget-wrapper {text-align: left;}
.footer-second-line .custom-html-widget {font-size: 12px;}
...
.footer-third-line {background: #680d3a;padding-left:5em;padding-right:5em;font-size: 0.8rem;color: #ccc;}
.fsl-list {padding: 0;margin: 3px 0 6px -10px;}
...
footer.site-footer {background-color: #680d3a;}
footer .col-7 p {margin-top: 0;}
header.site-header nav ul li a {font-family: 'Lato', serif;}
...
.msw::after {content:""; height: 2px; position: absolute; width: 100%;top:7px; background: #fff; left: 0; }
...
.home .mk_posts {margin-bottom: 1px;}
 .menu-sidebar-inner { background-color: #680d3a; }
...
.single header.entry-header {padding: 1em 5em;overflow: hidden;max-width: 1800px;margin: 0 auto;}
...
.single #secondary .article_holder .cb-article-meta h4, .single #secondary .article_holder .cb-article-meta h4 a {font-family: 'Playfair Display', serif;}
.single .entry-meta h1, .single .entry-content h2, .single .entry-content h3, .single .entry-content h4, .single .entry-content h5, .single #secondary .mk_related_caption, .single .mk_related_caption, .single .article_holder .cb-article-meta h4 a {font-family: 'Playfair Display', serif;}
...
.page-template-newmain-page-php .grid-f h3 a { font-family: 'Playfair Display', serif;  font-weight: 600;line-height: 1.2;font-size: 0.8em;  text-decoration: none;}
.page-template-newmain-page-php .title-f {text-align: center;font-family: 'Playfair Display', serif;}
.page-template-newmain-page-php .title-f h6, .page-template-newmain-page-php .title-f h1 {margin: 1em 0;position: relative;font-family: 'Playfair Display', serif; font-size: 2.5em;line-height: 0.8; text-transform: uppercase; font-weight: 900;}
...
.page-template-newmain-page-php .title-f h6 span, .page-template-newmain-page-php .title-f h1 span { font-family: 'Playfair Display', serif;  font-weight: 900;background: #fff;padding: 0 30px;display: inline-block;}
.page-template-newmain-page-php .title-f  small {display: block; font-size: 0.55em;font-family: 'Playfair Display', serif;color: #777; text-transform: none; }
...
.page-template-default .entry-title {font-family: 'Playfair Display', serif;font-weight: 900;}
...
.category-layout-v2  #cb-cat-title {color: #666;position: relative;padding-top: 18rem;text-align: left;font-family: 'Playfair Display', serif; font-size: 3.5em; margin: 0;}
.category-layout-v2 .cb-cat-desc {padding: 1em 5em;box-sizing: border-box;}
.category-layout-v2 .cb-cat-desc h2 {font-family: 'Playfair Display', serif; }
...
.p-cont-r h1, .p-cont-r h2, .p-cont-r h3, .p-cont-r h4, .p-cont-r h5, .p-cont-r h6, .p-cont-r h3 a{font-family: 'Playfair Display', serif; font-weight: bold;}
...
.slider {background: #fff;}
 ...
 .cb-cat-flex{padding:0 5em;box-sizing:border-box;position:relative;display:flex;margin:3px auto 0; font-family: 'Playfair Display', serif!important;}
 .cb-cat-container{max-width:75rem;margin-left:auto;margin-right:auto;padding:0 2rem!important;box-sizing: border-box;}
 .cb-cat-flex a{text-decoration:none;display:block;font-family: 'Playfair Display', serif;font-weight: 700;line-height: 1.1;}
 ...
 .cb-cat-flex .cb-flex-right .cb-flex-image h1{position:absolute;bottom:0;padding:10px 20px;background-color:#680e3a;color:white;text-transform:uppercase;transition-duration: 0.6s;}
 /*.cb-cat-flex .cb-flex-right .cb-flex-image h1:hover {background-color: #680e3a;color: white;}*/
 ...
 .h4{font-size:2em;font-weight:400;font-family: 'Playfair Display', serif;margin:0}
 .single .entry-content p > a[href*="https://www.amazon.com/"] {
	font-size: 2em;
...
aside {display: none;}
.single .inner-header-container { float: right;  width: 100%; min-width: inherit;}
...
.category-posts-wrap #load_more_latest_cats{margin-bottom: 20px;}
.category-layout-v2 .c-desc {padding: 0px 1em!important;}
}
body {visibility:visible !important;}
.load_more_latest_posts, .load_more_latest_cats {text-transform: uppercase; position: relative; overflow: hidden; cursor:pointer;width: 300px;margin: 20px auto 0;display: block;border: 0;color: #680d3a;padding: 10px;font-size: 20px;border: 2px solid #680d3a;font-family: 'Playfair Display', serif;font-weight: 600;}
...
* {color: #222;}
header.site-header {background: #680d3a;}
...
.page-template-newmain-page-php .grid-f h3 a, .page-template-front-page .grid-f h3 a { font-family: 'Playfair Display', serif;  font-weight: 600;line-height: 1.2;font-size: 1em;  text-decoration: none;}
.page-template-newmain-page-php .title-f, .page-template-front-page .title-f {text-align: center;font-family: 'Playfair Display', serif;}
.page-template-newmain-page-php .title-f h6, .page-template-newmain-page-php .title-f h1, .page-template-front-page .title-f h6, .page-template-front-page .title-f h1 {margin: 1em 0;position: relative;font-family: 'Playfair Display', serif; font-size: 2.5em;line-height: 0.8; text-transform: uppercase; font-weight: 900;}
...
.page-template-front-page .title-f h6 span, .page-template-front-page .title-f h1 span { font-family: 'Playfair Display', serif;  font-weight: 900;background: #fff;padding: 0 30px;display: inline-block;}
.page-template-newmain-page-php .title-f  small, .page-template-front-page .title-f  small {display: block; font-size: 0.55em;font-family: 'Playfair Display', serif;color: #777; text-transform: none; }
...
.buy-now-button {display: inline-block; padding: 10px 20px;background: #000;color: #fff; text-transform:uppercase;text-decoration: none;font-family: 'Playfair Display', serif;font-weight: 600;font-size: 1.3em;}
...
#cb-content .breadcrumbs .nav_breadcrumbs {
	font-size: 1.5em;
	padding-top: 0;
}
...
/* Replacement in styles to all <h> blocks */
.h4-replacement a {
	text-decoration: none;
	font-family: 'Playfair Display';
}
...
.social-links .icon-pinterest {
    ...
    margin: 0;
    box-sizing: border-box;
    /*background-image: url(/wp-content/themes/thegm/img/pin-it.jpg);*/
    border: 0px solid white;
    background-color: #620c36;
    color: white;
...
#masthead .menu-item-has-children .sub-menu {display: none; position: absolute; background-color: #680d3a; left: -6px; width: 200px;font-size: 14px;text-transform: none;text-align: left;padding: 10px;
}
#masthead .menu-item-has-children .sub-menu li {display: block;}
#masthead .menu-item-has-children:hover .sub-menu{display: block;margin-top: 0; }
...
.single .entry-content h4 {font-size: 1.3rem; margin: 1.3rem 0 0.8rem; font-family: Lato, sans-serif; font-weight: 400;color: #680d3a;}
...
.single .inner-header-container {height: 333px;}
.single .inner-header-container > div,.single .inner-header-container .post-thumbnail, .single .inner-header-container .post-thumbnail img {height: 100%;} 
.single .inner-header-container .post-thumbnail img {object-fit: cover;}
}
...
.msw {margin-top: 12px;}
.single header.entry-header .title-container h1 {font-size: 1.7rem;}
.single .entry-content h2, .single .entry-content h3 {font-size: 1.7rem;line-height: 1.1;padding-bottom: 15px;}
.single .entry-content h3 {font-size: 1.6rem;}
...
.entry-content tr, .entry-content td, .entry-content table, .entry-content tbody {display: block;width: auto;height: auto!important;}
#cb-content .breadcrumbs {margin-bottom: 4px;margin-left: 15px;margin-top: 3;}
#cb-content .breadcrumbs .nav_breadcrumbs {padding-top: 0;}
}
   ...
   <script type="text/javascript">
	    ...
	    window.addEventListener('scroll', function ( event ) {
	        if (!hasScrolled) {
	          ...
	          adsJs.async=" ";
	          adsJs.defer=" ";
	          adsJs.src = 'https://cdn.adapex.io/hb/aaw.glam.js';
	          ...
	          adsJs2.async=" ";
	          adsJs2.defer=" ";
	          adsJs2.src = '//get.s-onetag.com/9d2092cf-ef51-4f8b-a624-354ef1901a56/tag.min.js';
