...
.single .entry-content p > a {color: #f74a41;}
.single .entry-content p > a > span {color: #f74a41;}
...
.footer-second-line .col-3 .textwidget {color: #fff;text-align: left;}
.footer-second-line .col-3 .textwidget span, .footer-second-line .col-5 .textwidget small {color: #fff; text-transform: uppercase;	}
.footer-second-line .col-3 .textwidget p {color: #fff; margin: 0;}
.footer-second-line .col-3 .textwidget + .textwidget {width: 60%;}
.footer-second-line .col-3 .textwidget + .textwidget + .textwidget {}
...
.footer-third-line .textwidget {display: flex;justify-content: center;align-items: center;}
...
.slider {background: #fff;}
 ...
 .cb-cat-flex{padding:0 5em;box-sizing:border-box;position:relative;display:flex;margin:3px auto 0; font-family: 'PT Serif', serif!important;}
...
.buy-now-button {display: inline-block; padding: 10px 20px;background: #f74a41;color: #fff; text-transform:uppercase;text-decoration: none;font-family: 'PT Serif', serif;font-weight: 600;font-size: 16px; margin-top: 20px;}
...
#menu-sidebar ul.fsl-list {
	margin-left: 5px;
}
#menu-sidebar ul.fsl-list li {
    background-color: #f74e41;
    padding: 5px;
    padding-left: 0;
}
...
.bp-grid1-v5 li {display: block; margin: 0 0 2px; background: url('/wp-content/uploads/2019/04/mens-haircuts-shevron-m-350-90.png') no-repeat top right #ccc; padding: 20px; font-size: 16px;background-size: cover;}
...
.author-image {border-radius: 50%;max-width: 150px;margin: 22px 12px 12px 0px; display: inline-block;float:left; border-radius: 0}
...
@media (max-width: 768px) {.author-col{text-align: justify;}.author-col h1{text-align:center}.author-roles{text-align:center}.author-image { max-width: 150px; display: block; margin: auto; float: none;}
...
.flex-header .search img {padding-left: 0px;}
...
.footer-third-line .textwidget {flex-direction: column;}
.footer-third-line a {display: block; margin-bottom: 10px;}
}
/* Shop */
...
.footer-second-line { padding: 1.5em 1em 1.5em;}
.footer-second-line .col-7 .textwidget, .footer-second-line .col-5 .textwidget, .footer-second-line .col-5 .textwidget + .textwidget {width: 50%;}
.footer-second-line .col-9 .textwidget {
...
@media (min-width: 769px) {
	...
	.top-posts-v2 .col-p h3, .top-posts-v2 .col-p h2 {
		font-weight: 400;
	}
}
   ...
   <script type="text/javascript">
	    ...
	    window.addEventListener('scroll', function ( event ) {
	        if (!hasScrolled) {
	          ...
	          adsJs.async=" ";
	          adsJs.defer=" ";
	          adsJs.src = 'https://cdn.adapex.io/hb/aaw.lhs.js';
	          ...
	          adsJs2.async=" ";
	          adsJs2.defer=" ";
	          adsJs2.src = '//get.s-onetag.com/0c0c1e3e-827d-4a66-a83d-d4d3edaf79bc/tag.min.js';
			            ...
			            function addLocatorFrame() {
			                if (!window.frames['__cmpLocator']) {
			                    if (document.body) {
			                        ...
			                        frame.name = '__cmpLocator';                        document.body.appendChild(frame);
			                    } else {
