		...
		<div class="inner-header-container">
			...
			<div itemprop="publisher" itemscope itemtype="http://schema.org/Organization" class="publisher">
					<div itemprop="logo" itemscope itemtype="http://www.schema.org/ImageObject">
						<meta itemprop="url" content="<?php bloginfo('url'); ?>/wp-content/uploads/2016/04/Glaminati-logo-White.png">
					</div>
		...
		?>
			...
			<div class="cut-off-item">
				...
				<?php if($i==0){ ?>
					...
					<aside id="secondary" class="widget-area">
							...
							<div class="sidebar_ad_placement">
								<?php if( !glam_is_mobile() ){ echo "<div data-aaad='true' data-aa-adunit='/22181265/Glam_300v_1'></div>"; } ?>
							</div>
				...
				<?php } else { ?>
					...
					<aside class="widget-area secondary">
							<div class="stick_point"></div>
							<div class="sidebar_ad_placement">
									<?php if( !glam_is_mobile() ){ echo "<div data-aaad='true' data-aa-adunit='/22181265/Glam_300v_2'></div>"; } ?>
							</div>
					</aside>
			...
			<div class="cut-off-ad" style="margin-bottom: 30px; text-align: center;">
			    ...
			    <?php if ($i==1) { ?>
			      ...
			      <div data-aaad='true' data-aa-adunit='/22181265/Glam_1x1_outstream'></div>
			    <?php } else { ?>
